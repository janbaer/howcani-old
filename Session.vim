...
noremap <NL> ddp " Move line down
noremap  ddkP " Move line up"
...
nnoremap ,z :call ToggleErrors()w
map ,q :SyntasticCheck
map ,j :make
...
map ,hd :resize -10
map ,hi :resize +10
map ,vd :vertical resize -10
map ,vi :vertical resize +10
map ,a ggVG  " select all
nnoremap ,zz :let &scrolloff=999-&scrolloff
nnoremap ,l :call NumberToggle()
noremap ,h :set hlsearch!
noremap ,s :mksession! " Save current session reload with vim -S
vnoremap ,t :NERDTreeToggle
nnoremap ,t :NERDTreeToggle
onoremap ,t :NERDTreeToggle
noremap ,e :quit
vnoremap ,w :update
nnoremap ,w :update
onoremap ,w :update
noremap ,dd yyp " Duplicate the current line
...
nnoremap <silent> <BS> :set hlsearch!
xnoremap <silent> <BS> :set hlsearch!
onoremap <silent> <BS> :set hlsearch!
...
set pastetoggle=<F2>
set runtimepath=~/.vim,~/.vim/bundle/Vundle.vim,~/.vim/bundle/nerdtree,~/.vim/bundle/tagbar,~/.vim/bundle/vim-powerline,~/.vim/bundle/vim-javascript,~/.vim/bundle/vim-css-color,~/.vim/bundle/vim-css3-syntax,~/.vim/bundle/vim-less,~/.vim/bundle/vim-fugitive,~/.vim/bundle/vim-surround,~/.vim/bundle/nerdcommenter,~/.vim/bundle/ctrlp.vim,~/.vim/bundle/vim-easymotion,~/.vim/bundle/emmet-vim,~/.vim/bundle/typescript-vim,~/.vim/bundle/snipmate.vim,~/.vim/bundle/vim-easygrep,~/.vim/bundle/vim-editorconfig,~/.vim/bundle/vim-dispatch,~/.vim/bundle/vim-multiple-cursors,~/.vim/bundle/syntastic,~/.vim/bundle/YouCompleteMe,~/.vim/bundle/vim-unimpaired,~/.vim/bundle/vim-go,/usr/local/Cellar/macvim/7.4-84/MacVim.app/Contents/Resources/vim/vimfiles,/usr/local/Cellar/macvim/7.4-84/MacVim.app/Contents/Resources/vim/runtime,/usr/local/Cellar/macvim/7.4-84/MacVim.app/Contents/Resources/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/Vundle.vim,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle/nerdtree/after,~/.vim/bundle/tagbar/after,~/.vim/bundle/vim
set shell=zsh
set shiftround
set shiftwidth=2
...
silent only
cd /Volumes/Macintosh\ HD\ 2/Projects/howcani
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +7 src/app/components/scroll-detect/scroll-detect.component.js
badd +49 src/app/components/questions/questions.component.js
badd +5 src/app/components/questions/questions.tpl.html
argglobal
silent! argdel *
argadd src/app/components/scroll-detect/scroll-detect.component.js
edit src/app/components/scroll-detect/scroll-detect.component.js
...
exe 'vert 2resize ' . ((&columns * 223 + 127) / 255)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
